...
def map_error(err_str):
    ...
    return e # fallback to raw if unknown
...
for idx in range(4, len(df)):
    ...
    for st in stages:
        ...
        # >= June 13
        if ngay >= '2026-06-13' and ngay <= '2026-06-31':
...
with open('imported_june2.json', 'w', encoding='utf-8') as f:
    json.dump(final_data, f, ensure_ascii=False, indent=2)

print(f"Extracted {len(final_data)} grouped records from Excel Update (June 13 onwards).")
