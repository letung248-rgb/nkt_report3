...
for k, pipes in groups.items():
    ...
    final_data.append({
        ...
        'nguoi2': n2,
        'tinhTrang': tt,
        'ghiChu': 'Imported from Excel Update (Tháng 6 - P1)'
    })

with open('imported_june_fixed.json', 'w', encoding='utf-8') as f:
    json.dump(final_data, f, ensure_ascii=False, indent=2)

print(f"Extracted {len(final_data)} grouped records from Excel Update (June 1-12).")
