...
async function downloadExcel() {
    ...
    try {
        ...
        if (typeof EXCEL_TEMPLATE_B64 !== 'undefined') {
            ...
            wb.addWorksheet("T廙葓g quan");
            wb.addWorksheet("BC th獺ng");
            wb.addWorksheet("BC ng�y");
        }

        const wsData = wb.addWorksheet("D廙� li廙杮 NKT");
        const headers = ["ID", "Ngày", "Ca", "Nguyên công", "Số lượng ống", "Số ống chi tiết", "Loại xử lý", "Loại ống", "Mã bộ", "Số lần rửa", "Khoang chứa ống", "Từ giếng", "Từ giàn", "Số BBGN", "Hồ sơ giếng", "Áp suất", "Người TH 1", "Người TH 2", "Tình trạng", "Ghi chú"];
        ...
        dataToExport.forEach((r) => {
            ...
            const nguyenCongFull = r.nguyenCong + (r.dongHoNuoc ? ' [ĐH: ' + r.dongHoNuoc + ']' : '');
...
/g, ' ')
        ...
        wsData.columns.forEach((column, idx) => { 
